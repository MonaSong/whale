    ...
    <div class="s-container">
        ...
        <div class="s-page-content">
            ...
            <div class="form-container"> 
                <!-- 风险审核 -->
                <form role="form" action="" data-pane-id="risk-confirm" class="form-horizontal form-data-pane col-xs-12">
                  <div class="col-md-12">
                       <div class="form-group clearfix">
                           ...
                           <h4 class="col-md-5 black">风险确认<b name="institutionName"></b></h4>
                       </div>                
                       <div class="form-group clearfix" >
                           <label class="col-md-2 control-label">审核结果：</label>
                            <div class="col-md-5">
                                <select class="form-control" name="auditConfirmResult" data-role="control-btn">
                                    <option  value=""></option>
                                    <option  value="agree">风险确认</option>
                       ...
                       <div class="form-group clearfix" >
                           ...
                           <div class="col-md-5 ">
                               <textarea class="form-control textarea-view" name="auditConfirmMsg" data-role="control-btn" placeholder="请填写审核意见"></textarea>
                           </div>
                       </div>
                       <div class="form-group clearfix  btn-choose hide-status" operator-bottom>
                           <div class="col-xs-12 col-md-offset-2">
                               ...
                               <span class="btn btn-primary btn-red btn-confirm col-md-offset-1" data-role="submit-risk-confirm">确定</span>
                           </div>
                       </div> 
                   </div>               
                </form>
...
<script src="<%=request.getContextPath()%>/js/riskmanagement/risk_identification.js"></script>