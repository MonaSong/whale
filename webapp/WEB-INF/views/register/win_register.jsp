...
<script src="<%=request.getContextPath()%>/js/register/win_register.js"></script>
                        ...
                        <div class="whale-pane col-md-12">
	                        ...
	                        <div class="whale-pane-body register-boty">
	                            ...
	                            <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input class="form-control" type="text" id="inviteCode" name="inviteCode" placeholder="请输入邀请码（邀请码可以为空）">
                                    </div>
                                </div>
	                        </div>
	                    </div>    
	                        ...
	                        <div class="whale-pane-body register-boty">
	                            <div class="form-group licence-info">
	                                ...
	                                <div class="col-md-6 pic_show">
	                                    <div class="register_div">
		                                    <div class="upfilebox">
		                                        <input class="form-control bussinessLicense" onchange="readFile(this)" type="file" id="bussinessLicense" name="bussinessLicense">
	                            ...
	                            <div class="form-group licence-info">
	                                ...
	                                <div class="col-md-6 pic_show">
	                                    <div class="register_div">
                                            <div class="upfilebox">
                                                <input class="form-control taxRegistration" onchange="readFile(this)" type="file" id="taxRegistration" name="taxRegistration">
                                                <label class="lable lable-pic"></label>
                                            </div>
                                            <div id="register-view"></div>
                                        </div>
	                            ...
	                            <div class="form-group licence-info">
	                                ...
	                                <div class="col-md-6 pic_show">
	                                    <div class="register_div">
                                            <div class="upfilebox">
                                                <input class="form-control legalFrontCardPic" onchange="readFile(this)" type="file" id="legalFrontCardPic" name="legalFrontCardPic">
                                                <label class="lable lable-pic"></label>
                                            </div>
                                            <div id="register-view"></div>
                                        </div>
	                            ...
	                            <div class="form-group licence-info">
	                                ...
	                                <div class="col-md-6 pic_show">
	                                    <div class="register_div">
                                            <div class="upfilebox">
                                                <input class="form-control legalBackCardPic" onchange="readFile(this)" type="file" id="legalBackCardPic" name="legalBackCardPic">
                                                <label class="lable lable-pic"></label>
                                            </div>
                                            <div id="register-view"></div>
                                        </div>
	                            ...
	                            <div class="form-group licence-info">
	                                ...
	                                <div class="col-md-6 pic_show">
	                                    <div class="register_div">
                                            <div class="upfilebox">
                                                <input class="form-control wineryLivePic" onchange="readFile(this)" type="file" id="wineryLivePic" name="wineryLivePic">
                                                <label class="lable lable-pic"></label>
                                            </div>
                                            <div id="register-view"></div>
                                        </div>
