			...
			<form class="form-horizontal form-content form-data-pane col-xs-12" role="form" id="message-form" action="">
                    <div class="form-group">
                        ...
                        <div class="col-md-5 right-message">
                            <input class="form-control" disabled id="template_name"
                                name="template_name">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label" for="message_title">模板类型：</label>
                        <div class="col-md-5 right-message">
                            <input class="form-control" disabled id="message_title"
                                name="message_title">
                        </div>
                    </div>
                    <div class="form-group form-group-md">
                        <label class="col-md-2 control-label" for="template_type">消息标题：</label>
                        <div class="col-md-5 right-message">
                            <input class="form-control" id="messageTitle"
                                name="messageTitle">
                        </div>
                    </div>
                    <div class="form-group form-group-md">
                        ...
                        <div class="col-md-4 right-message">
                            <div class="service_content" id="service_role" name="service_role"></div>
                        </div>
                        <div class="col-md-2 btn-choose">
                            <span class="btn btn-primary  btn-add btn-blue" data-toggle="modal"
                                data-target=".bs-example-modal-md"><i class="img-message icon-add"></i>添加</span>
                        </div>
                    </div>
                    <div class="form-group form-group-md">
                        <label class="col-md-2 control-label" for="service_role">通知角色：</label>
                        <div class="col-md-4 right-message">
                            <div class="service_content" id="service" name="service_role"></div>
                        </div>
                        <div class="col-md-2 btn-choose">
                            <span class="btn btn-primary btn-service btn-add btn-blue" data-toggle="modal"
                                data-target=".bs-example-modal-time"><i class="img-message icon-add"></i>添加</span>
                        </div>
                    </div>
                    <div class="form-group form-group-md">
                       ...
                       <div class="form-group form-group-md">
                        <label class="col-md-2 control-label" for="advance_notice">提前通知天数：</label>
                        <div class="col-md-2 right-message" id="select_prov" data-role="prov">
                                <select class="form-control" id="advance_notice" name="notifyDays">
                                <option>请选择</option>
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                    ...
                    <div class="form-group form-group-md">
                        <label class="col-md-2 control-label" for="send_time">发送时间：</label>
                        <div class="col-md-2 right-message" data-role="time">
                            <select class="form-control" id="send_time" name="notifyTimes">
                                <option>请选择</option>
                                <option>10:00</option>
                                <option>15:00</option>
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 right-message" id="messagesendtype" name="messagesendtype">
...
<!-- 通知角色模态框  -->                           
<div class="modal fade bs-example-modal-time" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content audit-fail">
            <div class="modal-header fail-header">
                <span type="button" class="close" data-dismiss="modal">
                ...
                <div class="information-content">
                  <table  class="table table-striped table-bordered hover message-table" id="message-role">
                   ...
                   <tbody>
                    ...
                    <div class="modal-footer btn-choose">  
                        <a href="#" class="btn btn-default btn-cancel btn-gray btn-away audit-close" data-dismiss="modal">取消</a> 
    ...
    <div class="modal-dialog modal-md parameter-list">
        <div class="modal-content audit-fail description">
            <div class="modal-header fail-header">
                ...
                <h4 class="modal-title" id="mySmallModalLabel">参数说明</h4>
            </div>
                <ol class="title_list">
                 <p>变量使用说明：</p>
            ...
            <div class="modal-body message_time_table">
                <div class="information-content">
                  <table  class="table table-striped table-bordered hover parameter-table" id="message-role">
                   <thead>
                      <tr>
                        <td class="table-style">模板名称</td>
                        <td class="table-style">业务类型</td>
                        <td class="table-style">触发节点</td>
                        <td class="table-style">触发条件</td>
                        <td class="table-style">对应变量</td>
                        <td class="table-style">示例</td>
                      </tr>
                   </thead>
                   <tbody>
                      <tr>
