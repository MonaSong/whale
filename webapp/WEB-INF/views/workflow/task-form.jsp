...
<script src="${ctx}/js/workflow/task-form.js"></script>
<link href="${ctx}/css/workflow/task-form.css" rel="stylesheet">
...
<body>
	...
	<hr/>
	<form action="${ctx }/workflow/task/complete/${hasFormKey ? task.id : taskFormData.task.id}" class="form-horizontal" method="post">
