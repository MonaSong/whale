...
<script src="${ctx}/js/workflow/start-process-form.js"></script>
<link href="${ctx}/css/workflow/start-process-form.css" rel="stylesheet">
<body>
    <h3>
        启动流程—
    ...
    <hr />
    <form action="${ctx }/workflow/process-instance/start/${processDefinitionID}" class="form-horizontal" method="post">
        <c:if test="${hasStartFormKey}">
        ${startFormData}
        </c:if>
        <c:if test="${!hasStartFormKey}">
