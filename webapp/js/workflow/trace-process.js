...
$(function () {
    ...
    $('#changeToAutoDiagram').click(function() {
        ...
        $('#processDiagram').attr('src', contextPath + '/workflow/process/trace/data/auto/' + processInstanceId);
    });

});

function showActivities() {
    $.getJSON(contextPath + '/workflow/process/trace/data/' + executionId, function (infos) {
